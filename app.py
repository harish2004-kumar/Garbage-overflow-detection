...
# Define class names
class_names = ['Broken trash can', 'Healthy trash can', 'Trash can closed', 'Trash can open', 'Trash over flow']
    ...
    while cap.isOpened():
        ...
        for result in results:
            for box in result.boxes.data:
                ...
                label = f"{class_names[class_id]} ({conf:.2f})"  # Class name and confidence
